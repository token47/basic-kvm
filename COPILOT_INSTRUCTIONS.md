...
- Menu bar at the bottom with dropdown menus where you can change serial baud rate (with the default baudrate being 9600) and video input device. Also one for pasting text (sent as keyboard strokes).
